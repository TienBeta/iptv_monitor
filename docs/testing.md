...
Môi trường phát triển không truy cập được server stream thật, Google Apps Script thật và lịch chạy
của GitHub, nên 4 điểm dưới đây kiểm tra ngay sau khi làm xong [docs/setup.md](setup.md):

| Kiểm tra | Cách làm | Mong đợi |
|---|---|---|
| Stream thật | Bước C2 với `VN`, mức 3 | Run xanh trong ~3–5 phút; phần lớn kênh “Hoạt động”; nhiều kênh VN có thể “Bị chặn truy cập” vì runner ở Mỹ |
